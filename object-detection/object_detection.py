...
Original file is located at
    https://colab.research.google.com/drive/1PnTTNfQjvigxKaORdC4Af6_ZFUKD9GyR
...
results = model.train(data='/kaggle/working/dataset.yaml', epochs=10,device=0)
...
image_path = ['/kaggle/working/val/images/014de911-7810-4f7d-8967-3e5402209f4a_2048_448.jpg',]
...
for i in predictions:
    ...
    i.save(filename=f"/kaggle/predicted_image{predicted_images_count}.jpg")

predicted_image_path = '/kaggle/predicted_image1.jpg'
